...
export default function App() {
  ...
  const content = useMemo(
    () => ({
      ...
      timerText:
        "من يوم ماعرفتك وحياتي بقت أحلى، وكل لحظة بتعدي بتأكدلي إنك أجمل حد دخل حياتي، وإن قلبي اختارك من أول مرة ❤️",
      longMessage:
 ...
 const memoryCards = useMemo(
  () => [
    ...
    },
    {
      ...
      image: "/3.jpg",
      date: "أحلى لحظة",
      text: "❤️وهنا انتى كنتى بتدعى ربنا انك تكبرى بسرعه😂😂 علشان الصدفه تجمعنا ونحب بعض ونكون مع بعض فى الحلال يروح قلبى ♥️ 💋 (هنوشه) ♥️  (كابو)",
    },
    {
      id: 4,
